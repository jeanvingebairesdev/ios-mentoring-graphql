    ...
    return new Promise(async (resolve, reject) => {
      ...
      try {
        ...
        if (this.tracingConfig.enabled) {
          tracingHeaders.traceparent = (0, import_tracing.getTraceParent)();
        }
        debug({ flags });
...
You very likely have the wrong "binaryTarget" defined in the schema.prisma file.`
  ...
  async transaction(action, headers, arg) {
    ...
    if (action === "start") {
      ...
      const result = await import_Connection.Connection.onHttpError(this.connection.post("/transaction/start", jsonOptions, runtimeHeadersToHttpHeaders(headers)), transactionHttpErrorHandler);
      return result.data;
